# SkillGate Report — `tmp_uszoxz1` v0.0.0

| | |
|---|---|
| Policy | `balanced` v0.1 |
| Result | ⚠️ **WARN** |
| Timestamp | 2026-04-06T19:24:30Z |
...
### policy_check.py
BLOCK_VIOLATIONS:
- network_exec: /tmp/tmp_uszoxz1/tests/skill.py
- decode_and_run: /tmp/tmp_uszoxz1/tests/skill.py


### check-dangerous-commands.py
🔴 [BLOCK]
  - dynamic_execution: /tmp/tmp_uszoxz1/tests/skill.py
🟠 [REQUIRE_APPROVAL]
  - config_modification: /tmp/tmp_uszoxz1/tests/skill.py


### check-ioc.py
🟠 [WARN — SUSPICIOUS PATTERN]
  - suspicious pattern 'exec\(' in: /tmp/tmp_uszoxz1/tests/skill.py
