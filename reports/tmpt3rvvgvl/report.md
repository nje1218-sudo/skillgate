# SkillGate Report — `tmpt3rvvgvl` v0.0.0
...
### policy_check.py
BLOCK_VIOLATIONS:
- network_exec: /tmp/tmpt3rvvgvl/tests/skill.py
- decode_and_run: /tmp/tmpt3rvvgvl/tests/skill.py


### check-dangerous-commands.py
🔴 [BLOCK]
  - dynamic_execution: /tmp/tmpt3rvvgvl/tests/skill.py
🟠 [REQUIRE_APPROVAL]
  - config_modification: /tmp/tmpt3rvvgvl/tests/skill.py


### check-ioc.py
🟠 [WARN — SUSPICIOUS PATTERN]
  - suspicious pattern 'exec\(' in: /tmp/tmpt3rvvgvl/tests/skill.py
